...
Ext.Loader.addClassPathMappings({
  "Apotek.view.plpelunasan.BayarWin": "../../app/view/payment/BayarWin.js",
  "Apotek.view.plpelunasan.InfoPelunasan": "../../app/view/payment/InfoPelunasan.js",
  "Apotek.view.plpelunasan.KolektifWin": "../../app/view/payment/KolektifWin.js",
  "Apotek.view.plpelunasan.PelunasanWin": "../../app/view/payment/PelunasanWin.js",
  "Apotek.view.plpelunasan.RincianWin": "../../app/view/payment/RincianWin.js",
  "Apotek.view.plpelunasan.SuratWin": "../../app/view/payment/SuratWin.js",
  "Ext": "../../ext/src",
  ...
  "Override": "../../overrides",
  "Pas": "../../app",
  "Pas.view.retail.BayarForm": "../../app/view/retail/NonTunaiWin.js",
  "Pas.view.retail.DokterForm": "../../app/view/retail/DokterWin.js",
  "Pas.view.retail.FormPasien": "../../app/view/retail/PasienWin.js"
});

Ext.ClassManager.addNameAlternateMappings({
  "Apotek.view.plpelunasan.BayarWin": [],
  "Apotek.view.plpelunasan.InfoPelunasan": [],
  "Apotek.view.plpelunasan.KolektifWin": [],
  "Apotek.view.plpelunasan.PelunasanWin": [],
  "Apotek.view.plpelunasan.RincianWin": [],
  "Apotek.view.plpelunasan.SuratWin": [],
  ...
  "Pas.Application": [],
  "Pas.controller.App": [],
  "Pas.controller.AppSecurity": [],
  "Pas.controller.Base": [],
  "Pas.controller.getApps": [],
  "Pas.controller.getCash": [],
  "Pas.controller.getDirectBuy": [],
  "Pas.controller.getDoctor": [],
  "Pas.controller.getFaktur": [],
  "Pas.controller.getNonRetail": [],
  "Pas.controller.getOpname": [],
  "Pas.controller.getPatient": [],
  "Pas.controller.getPayment": [],
  "Pas.controller.getPmr": [],
  "Pas.controller.getProcurement": [],
  "Pas.controller.getPurchase": [],
  "Pas.controller.getRekanan": [],
  "Pas.controller.getRetail": [],
  "Pas.controller.getSale": [],
  "Pas.controller.getStock": [],
  "Pas.controller.getStockFlow": [],
  "Pas.controller.getStockIn": [],
  "Pas.controller.getSupplier": [],
  "Pas.controller.getUsers": [],
  "Pas.domain.Proxy": [],
  "Pas.model.Base": [],
  "Pas.model.menu.MenuModel": [],
  ...
  "Pas.singleton.Util": [],
  "Pas.store.app.MenuStore": [],
  "Pas.store.retail.DataDokter": [],
  "Pas.store.retail.DataPasien": [],
  "Pas.store.retail.ItemListRetail": [],
  "Pas.store.retail.Stocks": [],
  "Pas.store.retail.StocksDiskon": [],
  "Pas.store.retail.StocksSatuanItem": [],
  "Pas.store.retail.StocksZatActive": [],
  "Pas.store.retail.racikan.BiayaRacikan": [],
  "Pas.store.retail.racikan.DetailRacikan": [],
  "Pas.store.retail.racikan.JenisRacikan": [],
  "Pas.store.retail.racikan.Racikan": [],
  "Pas.store.retail.racikan.Stocks": [],
  "Pas.store.retail.racikan._tempDetailRacikan": [],
  "Pas.store.retail.racikan._tempRacikan": [],
  "Pas.store.stock.Stocks": [],
  "Pas.store.stock.StocksZatActive": [],
  "Pas.view.Main": [],
  "Pas.view.Viewport": [],
  "Pas.view.apps.getApps": [],
  "Pas.view.cash.CashGrid": [],
  "Pas.view.cash.getCash": [],
  "Pas.view.directbuy.BuyGrid": [],
  "Pas.view.directbuy.getDirectBuy": [],
  "Pas.view.doctor.FormDoctor": [],
  "Pas.view.doctor.GridDoctor": [],
  "Pas.view.doctor.getDoctor": [],
  "Pas.view.faktur.FakturDetailGrid": [],
  "Pas.view.faktur.FakturGrid": [],
  "Pas.view.faktur.getFaktur": [],
  "Pas.view.layout.MainLayout": [],
  "Pas.view.layout.NavDataPasien": [],
  "Pas.view.layout.NavFrontOffice": [],
  "Pas.view.layout.NavGudang": [],
  "Pas.view.layout.NavMaster": [],
  "Pas.view.layout.NavPengaturan": [],
  "Pas.view.nonretail.FormDetailPenjualan": [],
  "Pas.view.nonretail.FormPenjualan": [],
  "Pas.view.nonretail.GridItemJual": [],
  "Pas.view.nonretail.NonTunaiWin": [],
  "Pas.view.nonretail.getNonRetail": [],
  "Pas.view.opname.OpnameGrid": [],
  "Pas.view.opname.getOpname": [],
  "Pas.view.patient.FormPatient": [],
  "Pas.view.patient.GridListPatient": [],
  "Pas.view.patient.getPatient": [],
  "Pas.view.payment.PaymentGrid": [],
  "Pas.view.payment.getPayment": [],
  "Pas.view.pmr.getPmr": [],
  "Pas.view.procurement.ProcDetailGrid": [],
  "Pas.view.procurement.ProcGrid": [],
  "Pas.view.procurement.getProcurement": [],
  "Pas.view.purchase.PurchaseDetailGrid": [],
  "Pas.view.purchase.PurchaseGrid": [],
  "Pas.view.purchase.getPurchase": [],
  "Pas.view.rekanan.FormRekanan": [],
  "Pas.view.rekanan.GridRekanan": [],
  "Pas.view.rekanan.getRekanan": [],
  "Pas.view.retail.BayarForm": [],
  "Pas.view.retail.CariRacikanWin": [],
  "Pas.view.retail.DokterForm": [],
  "Pas.view.retail.DokterWin": [],
  "Pas.view.retail.FormDetailPenjualan": [],
  "Pas.view.retail.FormPasien": [],
  "Pas.view.retail.FormPenjualan": [],
  "Pas.view.retail.FormRacikan": [],
  "Pas.view.retail.GridItemJual": [],
  "Pas.view.retail.GridItemRacikan": [],
  "Pas.view.retail.JenisRacikanWin": [],
  "Pas.view.retail.NonTunaiWin": [],
  "Pas.view.retail.PasienWin": [],
  "Pas.view.retail.PmrWin": [],
  "Pas.view.retail.RacikanWin": [],
  "Pas.view.retail.getRetail": [],
  "Pas.view.sale.SaleDetailGrid": [],
  "Pas.view.sale.SaleGrid": [],
  "Pas.view.sale.getSale": [],
  "Pas.view.stock.StockGrid": [],
  "Pas.view.stock.getStock": [],
  "Pas.view.stockflow.StockGrid": [],
  "Pas.view.stockflow.getStockFlow": [],
  "Pas.view.stockin.StockInGrid": [],
  "Pas.view.stockin.getStockIn": [],
  "Pas.view.supplier.FormSupplier": [],
  "Pas.view.supplier.GridSupplier": [],
  "Pas.view.supplier.getSupplier": [],
  "Pas.view.users.FormUsers": [],
  "Pas.view.users.GridUsers": [],
  "Pas.view.users.getUsers": [],
  "Pas.view.users.login.Window": []
});

Ext.ClassManager.addNameAliasMappings({
  "Apotek.view.plpelunasan.BayarWin": [
    "widget.plpelunasan.bayarwin"
  ],
  "Apotek.view.plpelunasan.InfoPelunasan": [
    "widget.plpelunasan.infopelunasan"
  ],
  "Apotek.view.plpelunasan.KolektifWin": [
    "widget.plpelunasan.kolektifwin"
  ],
  "Apotek.view.plpelunasan.PelunasanWin": [
    "widget.plpelunasan.pelunasanwin"
  ],
  "Apotek.view.plpelunasan.RincianWin": [
    "widget.plpelunasan.rincianwin"
  ],
  "Apotek.view.plpelunasan.SuratWin": [
    "widget.plpelunasan.suratwin"
  ],
  "Ext.AbstractComponent": [],
  "Ext.AbstractManager": [],
  "Ext.AbstractPlugin": [],
  ...
  "Pas.store.retail.racikan.BiayaRacikan": [
    "store.retail.racikan.biayaracikan"
  ],
  "Pas.store.retail.racikan.DetailRacikan": [
    "store.retail.racikan.detailracikan"
  ],
  "Pas.store.retail.racikan.JenisRacikan": [
  ...
  "Pas.store.retail.racikan._tempRacikan": [
    "store.retail.racikan._tempracikan"
  ],
  "Pas.store.stock.Stocks": [
    "store.stock.stocks"
  ],
  ...
  "Pas.view.cash.CashGrid": [
    "widget.cash.cashgrid"
  ],
  "Pas.view.cash.getCash": [
    "widget.cash.getcash"
  ],
  "Pas.view.directbuy.BuyGrid": [
    "widget.directbuy.buygrid"
  ],
  "Pas.view.directbuy.getDirectBuy": [
    "widget.directbuy.getdirectbuy"
  ],
  "Pas.view.doctor.FormDoctor": [
    "widget.doctor.formdoctor"
  ],
  "Pas.view.doctor.GridDoctor": [
    "widget.doctor.griddoctor"
  ],
  "Pas.view.doctor.getDoctor": [
    "widget.doctor.getdoctor"
  ],
  "Pas.view.faktur.FakturDetailGrid": [
    "widget.faktur.fakturdetailgrid"
  ],
  "Pas.view.faktur.FakturGrid": [
    "widget.faktur.fakturgrid"
  ],
  "Pas.view.faktur.getFaktur": [
    "widget.faktur.getfaktur"
  ],
  "Pas.view.layout.MainLayout": [
    "widget.layout.mainlayout"
  ],
  "Pas.view.layout.NavDataPasien": [
    "widget.layout.navdatapasien"
  ],
  "Pas.view.layout.NavFrontOffice": [
    "widget.layout.navfrontoffice"
  ],
  "Pas.view.layout.NavGudang": [
    "widget.layout.navgudang"
  ],
  "Pas.view.layout.NavMaster": [
    "widget.layout.navmaster"
  ],
  "Pas.view.layout.NavPengaturan": [
    "widget.layout.navpengaturan"
  ],
  "Pas.view.nonretail.FormDetailPenjualan": [
    "widget.nonretail.formdetailpenjualan"
  ],
  "Pas.view.nonretail.FormPenjualan": [
    "widget.nonretail.formpenjualan"
  ],
  "Pas.view.nonretail.GridItemJual": [
    "widget.nonretail.griditemjual"
  ],
  "Pas.view.nonretail.NonTunaiWin": [
    "widget.nonretail.nontunaiwin"
  ],
  "Pas.view.nonretail.getNonRetail": [
    "widget.nonretail.getnonretail"
  ],
  "Pas.view.opname.OpnameGrid": [
    "widget.opname.opnamegrid"
  ],
  "Pas.view.opname.getOpname": [
    "widget.opname.getopname"
  ],
  "Pas.view.patient.FormPatient": [
    "widget.patient.formpatient"
  ],
  "Pas.view.patient.GridListPatient": [
    "widget.patient.gridlistpatient"
  ],
  "Pas.view.patient.getPatient": [
    "widget.patient.getpatient"
  ],
  "Pas.view.payment.PaymentGrid": [
    "widget.payment.paymentgrid"
  ],
  "Pas.view.payment.getPayment": [
    "widget.payment.getpayment"
  ],
  "Pas.view.pmr.getPmr": [
    "widget.pmr.getpmr"
  ],
  "Pas.view.procurement.ProcDetailGrid": [
    "widget.procurement.procdetailgrid"
  ],
  "Pas.view.procurement.ProcGrid": [
    "widget.procurement.procgrid"
  ],
  "Pas.view.procurement.getProcurement": [
    "widget.procurement.getprocurement"
  ],
  "Pas.view.purchase.PurchaseDetailGrid": [
    "widget.purchase.purchasedetailgrid"
  ],
  "Pas.view.purchase.PurchaseGrid": [
    "widget.purchase.purchasegrid"
  ],
  "Pas.view.purchase.getPurchase": [
    "widget.purchase.getpurchase"
  ],
  "Pas.view.rekanan.FormRekanan": [
    "widget.rekanan.formrekanan"
  ],
  "Pas.view.rekanan.GridRekanan": [
    "widget.rekanan.gridrekanan"
  ],
  "Pas.view.rekanan.getRekanan": [
    "widget.rekanan.getrekanan"
  ],
  "Pas.view.retail.BayarForm": [
    "widget.retail.BayarForm"
  ],
  "Pas.view.retail.CariRacikanWin": [
    "widget.retail.cariracikanwin"
  ],
  "Pas.view.retail.DokterForm": [
    "widget.retail.dokterform"
  ],
  "Pas.view.retail.DokterWin": [
    "widget.retail.dokterwin"
  ],
  "Pas.view.retail.FormDetailPenjualan": [
    "widget.retail.formdetailpenjualan"
  ],
  "Pas.view.retail.FormPasien": [
    "widget.retail.formpasien"
  ],
  "Pas.view.retail.FormPenjualan": [
    "widget.retail.formpenjualan"
  ],
  "Pas.view.retail.FormRacikan": [
    "widget.retail.formracikan"
  ],
  "Pas.view.retail.GridItemJual": [
    "widget.retail.griditemjual"
  ],
  "Pas.view.retail.GridItemRacikan": [
    "widget.retail.griditemracikan"
  ],
  "Pas.view.retail.JenisRacikanWin": [
    "widget.retail.jenisracikanwin"
  ],
  "Pas.view.retail.NonTunaiWin": [
    "widget.retail.nontunaiwin"
  ],
  "Pas.view.retail.PasienWin": [
    "widget.retail.pasienwin"
  ],
  "Pas.view.retail.PmrWin": [
    "widget.retail.pmrwin"
  ],
  "Pas.view.retail.RacikanWin": [
    "widget.retail.racikanwin"
  ],
  "Pas.view.retail.getRetail": [
    "widget.retail.getretail"
  ],
  "Pas.view.sale.SaleDetailGrid": [
    "widget.sale.saledetailgrid"
  ],
  "Pas.view.sale.SaleGrid": [
    "widget.sale.salegrid"
  ],
  "Pas.view.sale.getSale": [
    "widget.sale.getsale"
  ],
  "Pas.view.stock.StockGrid": [
    "widget.stock.stockgrid"
  ],
  "Pas.view.stock.getStock": [
    "widget.stock.getstock"
  ],
  "Pas.view.stockflow.StockGrid": [
    "widget.stockflow.stockgrid"
  ],
  "Pas.view.stockflow.getStockFlow": [
    "widget.stockflow.getstockflow"
  ],
  "Pas.view.stockin.StockInGrid": [
    "widget.stockin.stockingrid"
  ],
  "Pas.view.stockin.getStockIn": [
    "widget.stockin.getstockin"
  ],
  "Pas.view.supplier.FormSupplier": [
    "widget.supplier.formsupplier"
  ],
  "Pas.view.supplier.GridSupplier": [
    "widget.supplier.gridsupplier"
  ],
  "Pas.view.supplier.getSupplier": [
    "widget.supplier.getsupplier"
  ],
  "Pas.view.users.FormUsers": [
    "widget.users.formusers"
  ],
  "Pas.view.users.GridUsers": [
    "widget.users.gridusers"
  ],
  "Pas.view.users.getUsers": [
    "widget.users.getusers"
  ],
  "Pas.view.users.login.Window": [
    "widget.users.login.window"
  ]
});
